...
const MEN_PRODUCTS = [
  {"id":101,"name":"طقم تيشرت وشورت","price":250,"descripiption":"طقم رجالي صيفي شورت وتيشرت خامه هاديه وعاليه وسعر لا يقبل المنافسه اطلب الان قبل نفاذ الكميه","sizes":["S","M","L","XL"],"colors":["أسود","أبيض","كحلي"],"rating":5,"category":"men","isNew":true},
